...
BASE_DIR="review_runs/known_feature_similarity/semeval_2020_task11"
BASELINE_DIR="$BASE_DIR/v2"
OUT_DIR="$BASE_DIR/v4_lexical_cut_controlled"
...
uv run known-feature-similarity \
  ...
  --embedding-text-cleanup-builtin persuasion_high_confidence_boilerplate \
